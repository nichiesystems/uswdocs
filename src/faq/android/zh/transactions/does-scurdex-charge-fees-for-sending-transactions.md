# Does Scurdex charge fees for sending transactions?
...
These transaction fees do not pass through Scurdex but paid by the user directly to the network when executing transactions.
