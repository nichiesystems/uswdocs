...
Keep in mind, synchronization error means that Scurdex wallet app has problems synchronizing itself with the blockchain and doesn't affect the funds on wallet balance in any way.
